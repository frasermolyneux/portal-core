resource "azurerm_api_management_api_version_set" "legacy_repository_api" {
  name                = "repository-api"
...
resource "azurerm_api_management_product" "legacy_repository_api" {
...
resource "azurerm_api_management_product_policy" "legacy_repository_api" {
  product_id          = azurerm_api_management_product.legacy_repository_api.product_id
  resource_group_name = azurerm_api_management.legacy_apim.resource_group_name
  api_management_name = azurerm_api_management.legacy_apim.name
...
import {
  to = azurerm_api_management_api_version_set.legacy_repository_api
  id = "${azurerm_api_management.legacy_apim.id}/apiVersionSets/repository-api"
}

import {
  to = azurerm_api_management_product.legacy_repository_api
  id = "${azurerm_api_management.legacy_apim.id}/products/repository-api"
}

import {
  to = azurerm_api_management_product_policy.legacy_repository_api
  id = "${azurerm_api_management.legacy_apim.id}/products/repository-api"
}
