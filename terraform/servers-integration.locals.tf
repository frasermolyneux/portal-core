locals {
  servers_integration_function_app_identity = data.terraform_remote_state.portal_environments.outputs.managed_identities["servers_integration_webapi_identity"]
