...
resource "azurerm_api_management_product" "legacy_event_ingest_api" {
...
resource "azurerm_api_management_product_policy" "legacy_event_ingest_api" {
...
import {
  ...
  id = "${azurerm_api_management.legacy_apim.id}/apiVersionSets/event-ingest-api"
}
...
import {
  ...
  id = "${azurerm_api_management.legacy_apim.id}/products/event-ingest-api/policy"
}
